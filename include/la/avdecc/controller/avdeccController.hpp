...
public:
	...
	*/
	...
	public:
		...
		virtual void onEntityAcquired(la::avdecc::controller::Controller const* const /*controller*/, la::avdecc::controller::ControlledEntity const* const /*entity*/, la::avdecc::UniqueIdentifier const /*owningEntity*/) noexcept {} // TBD: We should later have a descriptor and index passed too, so we now which part of the EM graph has been acquired
		virtual void onEntityReleased(la::avdecc::controller::Controller const* const /*controller*/, la::avdecc::controller::ControlledEntity const* const /*entity*/) noexcept {} // TBD: We should later have a descriptor and index passed too, so we now which part of the EM graph has been released
		...
		// Entity model notifications (unsolicited AECP)
