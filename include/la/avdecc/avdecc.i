...
%nspace la::avdecc::entity::controller::DispatchContext;
%rename("%s") la::avdecc::entity::controller::DispatchContext; // Unignore struct (returned by ControllerEntity::getCurrentDispatchContext)
DEFINE_ENUM_CLASS(la::avdecc::entity::controller::DispatchContext::Kind, "byte")
// Unignore functions automatically generated by the following std_function calls (because we asked to ignore all methods earlier)
