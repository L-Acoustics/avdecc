...
class DiscoveryApp
{
	...
	class Discovery : IDisposable
	{
		...
		{
			public override void onTransportError(la.avdecc.controller.Controller controller, la.avdecc.controller.InterfaceType interfaceType)
			{
			...
			public override void onAecpRetryCounterChanged(la.avdecc.controller.Controller controller, la.avdecc.controller.ControlledEntity entity, ulong value, la.avdecc.controller.InterfaceType interfaceType)
			{
				var entityID = entity.getEntity().getEntityID().getValue().ToString("X");
				Console.WriteLine($"Aecp Retry Counter {entityID}: {value}");
			}

			public override void onAecpTimeoutCounterChanged(la.avdecc.controller.Controller controller, la.avdecc.controller.ControlledEntity entity, ulong value, la.avdecc.controller.InterfaceType interfaceType)
			{
				var entityID = entity.getEntity().getEntityID().getValue().ToString("X");
				Console.WriteLine($"Aecp Timeout Counter for {entityID}: {value}");
			}
			public override void onAecpUnexpectedResponseCounterChanged(la.avdecc.controller.Controller controller, la.avdecc.controller.ControlledEntity entity, ulong value, la.avdecc.controller.InterfaceType interfaceType)
			{
				var entityID = entity.getEntity().getEntityID().getValue().ToString("X");
				Console.WriteLine($"Aecp Unexpected Response Counter for {entityID}: {value}");
			}
			public override void onAecpResponseAverageTimeChanged(la.avdecc.controller.Controller controller, la.avdecc.controller.ControlledEntity entity, std.chrono.milliseconds value, la.avdecc.controller.InterfaceType interfaceType)
			{
				var entityID = entity.getEntity().getEntityID().getValue().ToString("X");
				Console.WriteLine($"Aecp Response Average Time for {entityID}: {value} msec");
			}

			public override void onAemAecpUnsolicitedCounterChanged(la.avdecc.controller.Controller controller, la.avdecc.controller.ControlledEntity entity, ulong value, la.avdecc.controller.InterfaceType interfaceType)
			{
				var entityID = entity.getEntity().getEntityID().getValue().ToString("X");
