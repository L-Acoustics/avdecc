...
private:
	...
	virtual void onStreamOutputCountersChanged(entity::controller::Interface const* const controller, UniqueIdentifier const entityID, entity::model::StreamIndex const streamIndex, entity::StreamOutputCounterValidFlagsMilan2019 const validCounters, entity::model::DescriptorCounters const& counters) noexcept override;
