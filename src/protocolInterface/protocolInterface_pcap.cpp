...
// ENABLE_AVDECC_PCAP_MULTICAST_JOIN opens the pcap interface without promiscuous mode, instead explicitly joining the AVDECC control multicast groups. If joining fails, promiscuous mode is tried.
